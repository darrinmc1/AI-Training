    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 cce1 wow animated fadeInUp animated" data-wow-delay="0.5s">
                <h6 class="widget-title"><?php the_field('address_title', 'options'); ?></h6>
                <div class="footer-info cce wow animated fadeInUp animated" data-wow-delay="0.5s">
                <p class="fic"><i class="flaticon-call iconpfooter2 "></i>&nbsp;&nbsp;&nbsp;<?php $phone = get_field('phone', 'options');  if ($phone) : ?><?php echo $phone ?><?php endif; ?></p><br>
            </div>
...
if (preloader) {
  ...
  particleground(document.getElementById('particles-foreground'), {
    dotColor: '<?php the_field('secondary','option');?>',
    lineColor: '<?php the_field('primary','option');?>30',
    minSpeedX: 0.3,
    maxSpeedX: 0.6,
    minSpeedY: 0.3,
    maxSpeedY: 0.6,
