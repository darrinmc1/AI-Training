...
wp_register_script('fancybox', get_template_directory_uri() . '/js/fancybox.min.js', array() , 1, 1, 1);
...
wp_register_script('pointer', get_template_directory_uri() . '/js/pointer.js', array() , 1, 1, 1);
wp_enqueue_script('pointer');

wp_register_script('yukari-cik', get_template_directory_uri() . '/js/yukari-cik.js', array() , 1, 1, 1);
wp_enqueue_script('yukari-cik');
  ...
  function ocdi_import_files() {
	return array(
		array(
			...
			'categories'                 => array( ''),
			'import_file_url'            => 'https://garantiwebdesign.com/setup/artora/demo-content.xml',
			'import_redux'               => array(

			),
			'import_preview_image_url'   => 'https://garantiwebdesign.com/setup/artora/screenshot.png',
			'import_notice'              => __( '', 'your-textdomain' ),
			'preview_url'                => 'https://www.garantiwebdesign.com/wordpress/artora',
		),
