...
<header class="page-header" data-background="<?php echo esc_url( get_field( 'header_background', 'options' ) ); ?>">
        <div class="container">
          <h2>Results For: <?php the_search_query(); ?></h2>
          <p><a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="headerbreadcrumb">Home</a> <i class="flaticon-right-chevron"></i>Search Results</p>
        </div>
        <!-- end container --> 
</header>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
            <div class="bosluksv"></div>
            <h2 class="h2-baslik-hizmetler-2">Search Results</h2>
            <div class="bosluksv"></div>
            ...
            <div class="col">
            <?php dynamic_sidebar('post-right-widgets'); ?>
            </div>
        </div>
    </div>
