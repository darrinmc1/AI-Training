...
<!-- Slider -->
<?php $specialeffects = get_field('special_effects'); ?>
<header class="slider">
...
<div class="swiper-wrapper">
        ...
        $h1color = get_sub_field('h1_color');
        $pcolor = get_sub_field('p_color');
        ...
        <div class="swiper-slide">
            <div class="slide-image" data-background="<?php echo $slide_image;?>"></div>
                ...
                <h1 style="color:<?php echo $h1color; ?>;"><?php echo $bigtext;?> <br>
                <?php echo $bigbottomtext;?> </h1>
                <p style="color:<?php echo $pcolor; ?>;"><?php echo $smalltext;?> </p>
                <div class="bosluk44"></div>
                <a href="<?php echo $link;?>" class="btn-3"><span class="btnn3"><?php echo $buttontext;?></span></a>
            </div>
            <img class="efc" src="<?php echo $specialeffects ['reflection']; ?>" alt="">
            <div class="artora"></div>
